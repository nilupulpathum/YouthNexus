...
<section class="dw-page dtd-page" aria-label="Divisional Secretary dashboard">
  ...
  <div class="dtd-grid">
    <section class="dw-panel dtd-panel" aria-labelledby="secretary-events-title">
      <header class="dw-panel__header"><div><h2 id="secretary-events-title">Upcoming Events</h2><p>Next approved events in this division</p></div><a class="dw-button dw-button--ghost" href="<?= ROOT ?>/manageevents">Manage events</a></header>
    ...
    <section class="dw-panel dtd-panel" aria-labelledby="secretary-attendance-title">
      <header class="dw-panel__header"><div><h2 id="secretary-attendance-title">Attendance Follow-up</h2><p>Recently completed events and recording progress</p></div><a class="dw-button dw-button--ghost" href="<?= ROOT ?>/attendance">Manage attendance</a></header>
    ...
    <section class="dw-panel dtd-panel" aria-labelledby="secretary-health-title">
      <header class="dw-panel__header"><div><h2 id="secretary-health-title">Club Health Overview</h2><p>Lowest current health scores are shown first</p></div><a class="dw-button dw-button--ghost" href="<?= ROOT ?>/divisionalclubhealth">View details</a></header>
