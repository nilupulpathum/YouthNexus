...
<section class="dw-page dtd-page" aria-label="Divisional Coordinator dashboard">
  ...
  <div class="dtd-grid">
    <section class="dw-panel dtd-panel" aria-labelledby="coordinator-applications-title">
      <header class="dw-panel__header"><div><h2 id="coordinator-applications-title">Pending Club Registrations</h2><p>Applications awaiting your decision</p></div><a class="dw-button dw-button--ghost" href="<?= ROOT ?>/clubregistrationapproval/index">Review all</a></header>
      <?php if ($applications): ?>
    ...
    <section class="dw-panel dtd-panel" aria-labelledby="coordinator-events-title">
      <header class="dw-panel__header"><div><h2 id="coordinator-events-title">Pending Event Approvals</h2><p>Division and club events requiring a decision</p></div><a class="dw-button dw-button--ghost" href="<?= ROOT ?>/eventapproval">Review all</a></header>
    ...
    <section class="dw-panel dtd-panel" aria-labelledby="coordinator-health-title">
      <header class="dw-panel__header"><div><h2 id="coordinator-health-title">Club Health Overview</h2><p>Lowest current health scores are shown first</p></div><a class="dw-button dw-button--ghost" href="<?= ROOT ?>/divisionalclubhealth">View details</a></header>
