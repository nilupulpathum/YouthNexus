    ...
    <div class="receipt-card">
        ...
        <div class="receipt-header">
            <div class="header-brand">
                ...
                <p>Sri Lanka National Administration &bull; Official Fund Disbursement Voucher</p>
            </div>
        ...
        <div class="receipt-body">
            <div class="grid-2">
                <div class="info-card">
                    ...
                    <div class="data-row"><span class="k">Target Zone:</span><span class="v"><?= htmlspecialchars($transfer->target_zone_name) ?></span></div>
