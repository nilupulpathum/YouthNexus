...
$pageDescription = 'Configure a report for your zone';
...
?>
<section class="dw-page dr-create" aria-label="Create zonal report">
  ...
  <form class="dw-panel dr-create-card" action="<?= ROOT ?>/zonalreports/generate" method="post" data-report-create-form>
    ...
    <header class="dr-create-card__header">
      ...
      <a class="dr-create-card__close" href="<?= ROOT ?>/zonalreports" aria-label="Close report configuration"><?= yn_icon('close') ?></a>
    </header>
    ...
    <div class="dr-create-card__body">
      <div class="dr-create-grid">
        ...
        <div class="dw-field dr-create-grid__full">
          ...
          <input id="report-scope" type="text" value="Zonal summary (divisions in <?= $e($zone->zonal_name) ?>)" readonly>
          <small class="dr-field-note"><?= yn_icon('info') ?><span>The report is restricted to records belonging to <?= $e($zone->zonal_name) ?>.</span></small>
        </div>
    ...
    <footer class="dr-create-card__footer">
      <a class="dw-button dw-button--secondary db-view-button db-view-button--back" href="<?= ROOT ?>/zonalreports">Back to Reports</a>
