...
$title = 'Treasurer Overview - YouthNexus';
$pageTitle = 'Treasurer Overview';
$pageDescription = 'Fund summary, shortcuts and club updates';
$currentRoute = 'treasurer';
$pageStyles = [ROOT . '/assets/css/divisional-workflows.css'];
$pageScripts = [ROOT . '/assets/js/divisional-workflows.js'];

$summaryCards = [
    ['value' => (string) ($funds['balance'] ?? ''), 'label' => 'Fund balance', 'note' => 'Current balance', 'icon' => 'file', 'tone' => 'blue'],
    ['value' => (string) ($funds['income'] ?? ''), 'label' => 'Total income', 'note' => 'All recorded income', 'icon' => 'download', 'tone' => 'green'],
    ['value' => (string) ($funds['expenses'] ?? ''), 'label' => 'Total expenses', 'note' => 'All recorded expenses', 'icon' => 'upload', 'tone' => 'red'],
    ['value' => (string) ($funds['pending_voids'] ?? 0), 'label' => 'Pending voids', 'note' => 'Awaiting resolution', 'icon' => 'clock', 'tone' => 'amber'],
];

require __DIR__ . '/../layouts/dashboard-start.view.php';
?>

<section class="dw-page" aria-labelledby="treasurer-overview-heading">
    <h1 id="treasurer-overview-heading" class="visually-hidden">Treasurer overview</h1>
    ...
    <section class="dw-panel" aria-labelledby="treasurer-shortcuts-heading">
        <header class="dw-panel__header">
            <div>
                <p>Treasurer actions</p>
    ...
    <section class="dw-panel" aria-labelledby="treasurer-announcements-heading">
        <header class="dw-panel__header">
            <div>
                <p>Stay informed</p>
    ...
    <section class="dw-panel" aria-labelledby="treasurer-events-heading">
        <header class="dw-panel__header">
            <div>
                <p>Plan ahead</p>
