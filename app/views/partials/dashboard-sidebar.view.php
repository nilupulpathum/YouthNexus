...
$navigation = [
    ...
    'divisionaltreasurer' => [
        ...
        ['label' => 'Assets', 'route' => 'manageassets', 'href' => $dashboardRoot . '/manageassets', 'icon' => 'briefcase'],
        ['label' => 'Clubs in Division', 'route' => 'clubs', 'href' => $dashboardRoot . '/clubs', 'icon' => 'users'],
        ['label' => 'Reports', 'route' => 'reports', 'href' => $dashboardRoot . '/reports', 'icon' => 'chart'],
        ['label' => 'Help', 'route' => 'help', 'href' => $dashboardRoot . '/help', 'icon' => 'help'],
    ],
    ...
    'nyscadmin' => [
        ...
        ['label' => 'Monitor Club Health', 'route' => 'clubhealth', 'href' => $dashboardRoot . '/clubhealth', 'icon' => 'trending-up'],
        ['label' => 'Manage User', 'route' => 'manageuser', 'href' => $dashboardRoot . '/manageuser', 'icon' => 'user-cog'],
        ['label' => 'National Analytics', 'route' => 'analytics', 'href' => $dashboardRoot . '/analytics', 'icon' => 'analytics'],
...
$icons = [
    ...
    'trending-up' => '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18" stroke-linecap="round" stroke-linejoin="round"/><polyline points="17 6 23 6 23 12" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    'analytics' => '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/><path d="M6 18v-4M10 18v-7M14 18v-2" stroke-linecap="round"/></svg>',
    ...
    <ul>
      <?php foreach ($roleItems as $item):
        ...
        $isActive = $activePath === $itemRoute
          || ($itemRoute === 'assets' && $activePath === 'manageassets')
