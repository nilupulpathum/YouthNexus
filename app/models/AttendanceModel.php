...
class AttendanceModel extends Model {
     ...
     *   in the division.
     * For SelectedClubs events: only members of the targeted clubs.
     *
     * @param  int    $eventId
     * @param  int    $divisionId
     * @param  string $targetScope  'AllInScope' | 'SelectedClubs'
     * @return array
     */
     ...
     * Uses the (event_id, user_id) unique key so re-submission
