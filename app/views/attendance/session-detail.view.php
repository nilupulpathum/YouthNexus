 ...
 * Full member roster for one Approved event, with Quick Update panel.
 */
$title                   = $title ?? 'Event Attendance — YouthNexus';
$pageTitle               = 'Attendance — ' . htmlspecialchars($event->title ?? 'Event');
$pageDescription         = 'View and manage attendance records for this event';
