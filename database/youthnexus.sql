...
-- ClubFlag (Club Flagging feature — feat-secretary-dashboard-integrated).
-- References Club and User, both already created above.
...
-- Additional seed users from feat-secretary-dashboard-integrated
-- (Divisional Coordinator + Treasurer test accounts for Colombo Division)
INSERT INTO User (username, email, password_hash, first_name, last_name, phone_number, role, status, division_id)
VALUES (
  'coord_colombo',
