...
?>
            ...
            <div class="am-section-header-row">
                <h2 class="am-section-heading">Approved Events</h2>
            </div>
        ...
        <div class="am-modal-body">
            ...
            <div class="am-tab-pane" id="paneBulk">
                ...
                <div class="am-csv-note">
                    ...
                    <em>UNCONFIRMED — this column format is inferred from design notes and has been flagged for Nimesh to verify before treating it as stable.</em><br>
