...
<div class="ann-toolbar">
    ...
    <div class="ann-filter-actions">
        ...
        <select
            class="ann-tab-select"
            id="annTabSelect"
        >

            <option value="All Announcements">
                All Announcements
            </option>
...
<link
    rel="stylesheet"
    href="<?= ROOT ?>/assets/css/announcements.css"
>


<link
    rel="stylesheet"
    href="<?= ROOT ?>/assets/css/divisional-components.css?v=<?= time() ?>"
>


<script
    src="<?= ROOT ?>/assets/js/announcements.js?v=<?= time() ?>"
></script>
